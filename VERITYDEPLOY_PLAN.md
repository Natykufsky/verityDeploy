...
- Site process controls for queue restart, Horizon terminate, supervisor restart, daemon status checks, and daemon stack recovery.
...
- Background daemon/process automation and recovery heuristics.

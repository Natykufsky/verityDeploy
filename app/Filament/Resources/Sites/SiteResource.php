...
class SiteResource extends Resource
{
    ...
    public static function webhookSettings(Schema $schema): Schema
    {
        return WebhookSettingsInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'cpanel-bootstrap-wizard' => CpanelBootstrapWizard::route('/{record}/cpanel-bootstrap-wizard'),
            'webhooks' => WebhookSettings::route('/{record}/webhooks'),

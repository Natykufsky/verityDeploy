<div id="site-terminal" class="scroll-mt-28 space-y-4">
    ...
    <div
        ...
        class="deployment-frost-panel rounded-3xl p-4"
    >
        <div class="flex flex-wrap items-center justify-between gap-3">
            <div>
                <div class="text-xs uppercase tracking-[0.2em] text-cyan-200/70">Terminal</div>
                <p class="mt-1 text-sm text-slate-400">The console stays inside the site folder and streams live output while queued jobs run.</p>
            </div>
            <button
                type="button"

<div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
    <div class="deployment-frost-panel rounded-2xl p-4">
        <div class="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-500">
            <span>status</span>
            <x-info-tooltip text="The current backup state for this site." label="Backup status help" />
        </div>
    ...
    <div class="deployment-frost-panel rounded-2xl p-4">
        <div class="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-500">
            ...
            <x-info-tooltip text="The most recent successful backup snapshot." label="Latest backup help" />
        </div>
    ...
    <div class="deployment-frost-panel rounded-2xl p-4">
        <div class="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-500">
            <span>latest snapshot path</span>
            <x-info-tooltip text="The filesystem path of the latest backup snapshot." label="Latest snapshot path help" />
        </div>
